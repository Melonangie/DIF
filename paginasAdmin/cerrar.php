...
<html>
   ...
   ================================================== -->
        ...
        <style>.container-narrow { max-width: 980px;}</style>
    </head>
    ...
    <body>
        ...
        <div class="container-narrow"><!-- contenedor -->
            ...
            <section class="row-fluid ">
                <div class="titulo centrar title-print">Cierre de Curso</div>
                ...
                <table id="addressesTable" width="100%">
                    <thead>
                        <tr>
                            <th width="5%">&nbsp;</th>
                            <th width="15%"><span class="no-print"> N&uacute;mero de </span>Folio</th>
                            <th width="30%">Nombre de Ella</th>
                            <th width="30%">Nombre de El</th>
                            <th width="20%">Terminar&oacute;n</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        for ($i = 0; $i < count($tabla); $i++) {
                            ...
                            echo '<td width="30%">' . $tabla[$i]['ella'] . '</td>';
                            echo '<td width="30%">' . $tabla[$i]['el'] . '</td>';
                            echo '<td width="20%"><div class="editable" id="' . $tabla[$i]['id'] . '">' . $tabla[$i]['term'] . '</div></td>';
                            echo '</tr >';
                            $i2++;
                        }
                        ?>
                ...
                <p class="text-center margin-top no-print" >
                    <button class="btn dif" onClick="window.location.reload()">Actulaizar valores</button>
                    <button class="btn " onClick="window.location = 'menu.php'">Regresar al Menu</button>
                </p>
