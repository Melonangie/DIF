...
if (isset($_GET['id'])) {
    $id = getGet('id', $db);
    $info = traerTodo('folio', 'folio_id', $id, $db);
    ...
    <body>
        ...
        <div class="container-narrow"><!-- contenedor -->
            ...
            <div class="row-fluid ">
                        ...
                        if ($error == 0) {
                            ...
                            if ($update) {
                                ...
                                echo "<div class='alert alert-success text-center'>
                                            ...
                                            <button class='btn btn-success' onClick=\"window.location = 'calendario.php?id=".$id."'\">Modificar Fecha</button> 
                                            <button class='btn' onClick=\"window.location = 'despedida.php?id=".$id."'\">Despedida</button> 
                                          </div>";
                            }
                            else
                ...
                <form id="forma-ingresar" class="form-horizontal" action='<?php echo $_SERVER['PHP_SELF'].'?id='.$id; ?>' method="post">
         ...
         ================================================== -->
                    ...
                    <div class="form-actions">
                        <div class="text-center">
                            ...
                            <a href = "menu.php" class="btn mm">Regresar al Menu</a >
                        </div>
