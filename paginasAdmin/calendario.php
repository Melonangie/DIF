...
<html>
    ...
    <body>
        ...
        <div class="container-narrow"><!-- contenedor -->
            ...
            if (isset($_POST['fecha']) && $_POST['fecha'] == 'fecha') {
                ...
                if (isset($_POST['alternate'], $_POST['alternate2'])) {
                    ...
                    if (!isEmpty($fecha) && !isEmpty($fecha2) && validaTipo($fecha, 'date')) {
                        ...
                        <h4>¡Bien!</h4> 
                        La fecha <strong>" . $fecha2 . "</strong> se ha agregado exitosamente al registro.<br />
                        <button class='btn btn-success' onClick=\"window.location = 'despedida.php?id=" . $parejaId . "'\">Siguiente</button> 
                      </div>";
                        }
                        else
            ...
            <form method="post" id="cita" action='<?php echo $_SERVER['PHP_SELF'] . '?id=' . $parejaId; ?>'>
