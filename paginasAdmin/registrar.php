...
<html>
    <head>
       ...
       ================================================== -->
        ...
        <script src="../js/registrarAdmin.js" type="text/javascript"></script>
    </head>
                ...
                <div class="span8">
                    ...
                    if (isset($_POST['registrar']) && $_POST['registrar'] == 'registrar') {
                        if (isset($_POST['nuevo_usuario'], $_POST['clave'], $_POST['clave2'])) {
                            ...
                            if ($error == 0) {
                                ...
                                //hace el registro
                                if (registraAdmin($usuario, $password, $db)) {
                                    //cierra la conexion
                                    $db->closeConnexion();
                                    echo "<div class='alert alert-success text-center'>
                                             <h4>¡Bien!</h4> Su usuario <strong> $usuario </strong> con derechos de Administrador se ha creado con &eacute;xito.
                                             <p><a class='btn btn-success' href='../index.php' >Ingrese</a></p>
                                          </div>";
                                } else {
                                    $error = 123;
                                    $db->closeConnexion();
                    ...
                    <form method="post" id="login-form" class="form-horizontal"  action='<?php echo $_SERVER['PHP_SELF']; ?>' >
                        <fieldset>
                            ...
                            <legend>Creaci&oacute;n de Administrador</legend>

                            <ul>
                                <li>Debe contener solo letras y n&uacute;meros</li>
                                <li>M&iacute;nimo 6 caracteres y m&aacute;ximo 10</li>
                        ...
                        <fieldset>
                            ...
                            <ul>
                                <li>Debe contener m&iacute;nimo 8 caracteres</li>
                                <li>Use una frase o palabra f&aacute;cil de recordar</li>
                            </ul>
                            ...
                            <div class="form-actions text-center margin-top">
                                <button type="submit" class="btn dif" name="registrar" value="registrar">Registrar Administrador</button>
                                <button class="btn center" onClick="window.location = 'menu.php'">Regresar al Menu</button>
                            </div>
