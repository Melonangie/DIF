...
if (isset($_GET['id'])) {
    ...
    //traduce la fecha
    $dia2 = substr($info['disponible_id'], 8, 2);
    $ano = substr($info['disponible_id'], 0, 4);
    $dia = traduceDias($info['disponible_id']);
    $mes = traduceMes($info['disponible_id']);
}
            ...
            <section class="row-fluid">
                ...
                <div class="span8 offset2 margin-top">
                    ...
                    <div class="margin-top well well-large">
                        <p class="text-center" >
                            Su numero de inscripcion es: <strong> <?php echo $id; ?></strong>
                        </p>
                        <p class="text-center" >
                            Su numero de recibo es: <strong> <?php echo $info['recibo']; ?></strong>
                        </p>
                        <p class="text-center" >
                            Su fecha de platica es: 
                            <strong> 
                                <?php
